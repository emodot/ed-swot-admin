    ...
    <div className={`relative flex flex-col mb-[1.5rem]`}>
      {label && (
        <label
          htmlFor={name}
          className={`
            text-black bg-white mb-2 font-aileron_r cursor-text`}
        >
          {label}
        </label>
      )}
      <DatePicker
        renderCustomHeader={({
          ...
          <div className="flex justify-between items-center px-3">
            ...
            <select
              ...
              className="text-[#000000] h-8 rounded-lg flex justify-center items-center focus:border outline-none w-16 px-0.5"
            >
              {years.map((option) => (
            ...
            <select
              ...
              className="text-[#000000] h-8 rounded-lg flex justify-center items-center focus:border outline-none"
            >
              {months.map((option) => (
                <option key={option} value={option}>
                  {option}
        ...
        name={name}
        className={` ${styles} border-b-border_stroke_1 h-[50px] px-4 text-[16px] sm:text-14 w-full text-[#000000] outline-0 border-b font-aileron_r  hide_tap bg-[#00000000]`}
      />
      {showCalender && (
